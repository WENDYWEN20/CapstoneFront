...
import Delete from '../pages/DeleteCart.jsx'
    ...
    <div>
      ...
      <div>
        ...
        {cart.map((item) => ( <div key={item._id}>
          ...
          <button  className="flex hover:bg-blue-600 transition-all duration-300 shadow-lg" onClick={() => removeFromCart(item._id)}>Delete</button>
